...
const BrowseCategories = () => {
  ...
  const [savingId, setSavingId] = useState(null); // track which item is being saved
  ...
  // ✅ Single handler — uses WishlistContext, shows single toast
  const handleBookmarkClick = async (offerId) => {
    ...
    if (savingId === offerId) return; // prevent double click
    setSavingId(offerId);
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {categoryData.offers.map((offer, index) => {
                  ...
                  // ✅ Reads from shared WishlistContext Set — always in sync
                    ...
                    >
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          ...
                          {/* ✅ Bookmark Button — filled when saved, outline when not */}
                          <Button
                            variant="ghost"
