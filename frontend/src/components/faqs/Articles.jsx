        ...
        <div className="lg:flex gap-8">
          <div className="lg:w-[536px] h-[218px] rounded-lg bg-[#00308F] text-white">
            <div className="flex items-center gap-6">
                ...
                <div className="mt-14">
                    <h1 className="text-2xl font-bold mb-2">Having trouble logging in?</h1>
                    <h1 className="mb-4">Refer to the following articles to help tackle <br /> your logging in query</h1>
