...
const Works = () => {
  return (
    <section className="mb-10 mt-10 bg-white text-center w-full lg:max-w-7xl mx-auto">
      ...
      >
        <h2 className="lg:text-4xl text-xl font-bold common-text mb-2 inter-text">
          How It Works
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8  px-6">
        {/* Step 01 */}
        <motion.div
          className="relative bg-white shadow-md rounded-xl p-8 text-center  hover:shadow-lg transition border border-blue-900 border-b-4  border-b-[#00308F]"
        ...
        {/* Step 02 */}
        <motion.div
          className="relative bg-white shadow-md rounded-xl p-8 border border-blue-900 border-b-4 text-center hover:shadow-lg transition border-b-[#00308F]"
          initial={{ scale: 0 }} // start smaller
          whileInView={{ scale: [0, 1.2, 1] }} // zoom in to 1.2, then back to 1
